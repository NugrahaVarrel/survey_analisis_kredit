...
export class ApiService {
  ...
  private creditScoreApi: string =
    'https://68cb7d6a716562cf5073a1ee.mockapi.io/credit_score';
  ...
  getCreditScore(): Observable<any> {
    return this.http.get(this.creditScoreApi);
  }

  postCreditScore(data: any): Observable<any> {
    return this.http.post(this.creditScoreApi, data);
  }
